...
getMeasureFromMongo <- function(queueID){
  ...
  mongo <- mongo.create(host="localhost:27017",username="netmap",password = "brocoli̩umvegetal")
...
testRealModels<-function(facilityName){
  ...
  mongo <- mongo.create(host="52.67.171.39:27017",username="netmap",password = "brocoli̩umvegetal")
